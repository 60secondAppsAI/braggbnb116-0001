						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="Rating" type="text" placeholder="Enter Rating" v-model="hostToAdd.rating"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Rating</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Rating" type="text" placeholder="Enter Rating" v-model="hostDetails.rating"></input>
																		</div>
						</td>
														</tr>
